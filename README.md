...
| 4 | Аппаратные решения | Заключаются в использовании печатных модулей (плат), содержащих дополнительный микропроцессор и “лишнюю” оперативную и видеопамять от другой аппаратной платформы |
| --- | --- | --- |
